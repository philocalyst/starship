...
pub const fn entry_for(module: BuiltinModule) -> ModuleEntry {
    ...
    match module {
        ...
        M::GitState => ModuleEntry {
            description: "The current Git operation, and it's progress",
        ...
        M::Cpp => ModuleEntry {
            description: "your cpp compiler type",
        ...
        M::Quarto => ModuleEntry {
            description: "The current installed version of quarto",
        ...
        M::Typst => ModuleEntry {
            description: "The current installed version of typst",
